...
public class ReportesAdapter extends RecyclerView.Adapter<ReportesAdapter.ViewHolder> implements OnClickListListener {
    ...
    private ReportesItem orderItem;


    public ReportesAdapter(ArrayList<VisitedEntity> list, Context context, ReportesItem orderItem) {
        this.list = list;
        //setStatus();
