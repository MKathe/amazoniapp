...
public class TablePagantesFragment extends BaseFragment implements TablePagantesContract.View {
    ...
    private TablePagantesAdapter mAdapter;
    private LinearLayoutManager mLayoutManager;
    private TablePagantesContract.Presenter mPresenter;
    private ProgressDialogCustom mProgressDialogCustom;

    public TablePagantesFragment() {
    ...
    public static TablePagantesFragment newInstance() {
        return new TablePagantesFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new TablePagantesAdapter(new ArrayList<VisitedEntity>(), getContext(), (ProductItem) mPresenter);
    ...
    @Override
    public void setPresenter(TablePagantesContract.Presenter mPresenter) {
