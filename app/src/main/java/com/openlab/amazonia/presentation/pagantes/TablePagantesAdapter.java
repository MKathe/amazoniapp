...
public class TablePagantesAdapter extends RecyclerView.Adapter<TablePagantesAdapter.ViewHolder> implements OnClickListListener {
    ...
    public TablePagantesAdapter(ArrayList<VisitedEntity> list, Context context, ProductItem orderItem) {
        this.list = list;
        //setStatus();
