...
public class RecaudationPresenter implements RecaudationContract.Presenter {

    private final RecaudationContract.View mView;
    private final SessionManager mSessionManager;
    private Context context;
    private boolean firstLoad = false;
    private int currentPage = 1;

    public RecaudationPresenter(RecaudationContract.View mView, Context context) {
        this.mView = mView;
