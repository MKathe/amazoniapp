...
public class ReportesPresenter implements ReportesContract.Presenter, ReportesItem {

    private final ReportesContract.View mView;
    private final SessionManager mSessionManager;
    private Context context;
    private boolean firstLoad = false;
    private int currentPage = 1;

    public ReportesPresenter(ReportesContract.View mView, Context context) {
        this.mView = mView;
