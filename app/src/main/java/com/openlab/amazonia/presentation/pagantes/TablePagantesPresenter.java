...
public class TablePagantesPresenter implements TablePagantesContract.Presenter, ProductItem {

    private final TablePagantesContract.View mView;
    private final SessionManager mSessionManager;
    private Context context;
    private boolean firstLoad = false;
    private int currentPage = 1;

    public TablePagantesPresenter(TablePagantesContract.View mView, Context context) {
        this.mView = mView;
