...
public class PagantesPresenter implements PagantesContract.Presenter {

    private final PagantesContract.View mView;
    private final SessionManager mSessionManager;
    private Context context;
    private boolean firstLoad = false;
    private int currentPage = 1;

    public PagantesPresenter(PagantesContract.View mView, Context context) {
        this.mView = mView;
