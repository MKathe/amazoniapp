...
import com.openlab.amazonia.presentation.visited.ProductItem;
...
public class VisitedPresenter implements VisitedContract.Presenter, VisitedItem {
    ...
    public void loadList(int id) {
        ...
        Call<ResponseVisited> reservation = listRequest.getListVisited("Token " + mSessionManager.getUserToken(), id);
