...
public class TableRecaudationPresenter implements TableRecaudationContract.Presenter, ProductItem {

    private final TableRecaudationContract.View mView;
    private final SessionManager mSessionManager;
    private Context context;
    private boolean firstLoad = false;
    private int currentPage = 1;

    public TableRecaudationPresenter(TableRecaudationContract.View mView, Context context) {
        this.mView = mView;
