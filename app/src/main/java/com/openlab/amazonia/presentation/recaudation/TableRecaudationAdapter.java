...
public class TableRecaudationAdapter extends RecyclerView.Adapter<TableRecaudationAdapter.ViewHolder> implements OnClickListListener {
    ...
    public TableRecaudationAdapter(ArrayList<VisitedEntity> list, Context context, ProductItem orderItem) {
        this.list = list;
        //setStatus();
